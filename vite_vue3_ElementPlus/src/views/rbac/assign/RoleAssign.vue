        ...
        <template #default="{ node, data }">
          <span class="custom-tree-node">
            ...
            <span>
              <el-link
                type="primary"
                @click.stop="assignRoles(data,node)"
                v-if="node.level===2&&data.id!=='1'"
                :underline="false"
              >分配角色</el-link>
            </span>
          </span>
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button
            ...
            :loading="assignRolesDialog.loading"
          >确 定</el-button>
        </div>
      </template>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    submitAssignRoles() {
      ...
      groupApi
        .assignRoles(
          this.assignRolesDialog.assignRoleIds,
          this.assignRolesDialog.groupId
        )
        .then(() => {
